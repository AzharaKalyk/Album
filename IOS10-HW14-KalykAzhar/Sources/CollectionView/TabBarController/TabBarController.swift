...
final class TabBarController: UITabBarController {
    ...
    static func createTabBarConroller() -> UITabBarController {
        ...
        tabBarController.setViewControllers(
            [
                createChildViewConroller(controller: MediaViewController(), title: "Медиатека", image: UIImage(systemName: "photo.fill.on.rectangle.fill"), tag: 0),
                createChildViewConroller(controller: ForYouViewController(), title: "Для Вас", image: UIImage(systemName: "heart.text.square.fill"), tag: 1),
                createChildViewConroller(controller: ViewController(), title: "Альбомы", image: UIImage(systemName: "rectangle.stack.fill"), tag: 2),
                createChildViewConroller(controller: SearchViewController(), title: "Поиск", image: UIImage(systemName: "magnifyingglass"), tag: 3)
            ],
            animated: true
        )
